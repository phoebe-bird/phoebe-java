...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../phoebe-java-core/src/main/resources/META-INF/proguard/phoebe-java-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../phoebe-java-core/src/main/resources/META-INF/proguard/phoebe-java-core.pro",
