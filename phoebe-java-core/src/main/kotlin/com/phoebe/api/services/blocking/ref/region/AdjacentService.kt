...
interface AdjacentService {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): AdjacentService
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): AdjacentService.WithRawResponse
